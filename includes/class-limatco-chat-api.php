...
class Limatco_Chat_Api {
	...
	private function classify_query( $api_key, $model, $user_message, $history = array() ) {
		...
		$system = "Eres un clasificador. Dada una conversación entre un usuario y un asistente sobre productos de construcción, "
			...
			. "- Si el usuario consulta por algún producto de algún color (ej: Cerámica Blanca) los resultados deben ser exclusivamente productos de aquel color buscando el color en el título o en los colores predominantes de la ficha del producto. Lo mismo aplica con medidas de revestimientos o estilos de productos (rugoso, texturados, antideslizantes, decorados, etc.).\n"
